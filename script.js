document.addEventListener("DOMContentLoaded", () => {
  ...
  // Zapier expects flat key/value pairs so convert nested objects
  // like formData.vehicles[0].year into "vehicles0_year" fields.
  ...
  function submitToNetlify(data) {
    ...
    Object.entries(flat).forEach(([key, value]) => payload.append(key, value));
    fetch("/", { method: "POST", body: payload }).catch((err) =>
