document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchMakesForYear() {
    if (!makeCache) {
      const types = ["passenger car", "truck"];
        ...
        driversContainer.insertAdjacentHTML(
          ...
          `
            <fieldset class="driver" data-index="${i}">
              ...
              <input type="text" name="driverFirst${i}" placeholder="First Name" required />
              <input type="text" name="driverLast${i}" placeholder="Last Name" required />
              <input type="date" name="driverDob${i}" placeholder="Date of Birth" required />
